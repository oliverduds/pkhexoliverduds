...
public sealed class RareEventItem
{
    ...
    public int Generation { get; init; } = 7;
    public string OriginGame { get; init; } = string.Empty;
...
public static class RareEventCatalog
{
    ...
    [
        ...
        new()
        {
            ...
            Year = 2013,
            Generation = 5,
            OriginGame = "Black 2 / White 2 (Gen 5)",
        ...
        new()
        {
            ...
            Year = 2008,
            Generation = 4,
            OriginGame = "Diamond / Pearl (Gen 4)",
            Region = "Global",
            Tier = EventTier.TierSPlus,
            Category = EventCategory.Mythical,
        ...
        new()
        {
            ...
            Year = 2009,
            Generation = 4,
            OriginGame = "Diamond / Pearl / Platinum (Gen 4)",
        ...
        new()
        {
            ...
            Year = 2018,
            Generation = 7,
            OriginGame = "Ultra Sun / Ultra Moon (Gen 7)",
            Region = "Global",
            Tier = EventTier.TierSPlus,
            Category = EventCategory.Mythical,
        ...
        new()
        {
            ...
            Year = 2016,
            Generation = 7,
            OriginGame = "Sun / Moon (Demo) (Gen 7)",
            Region = "Global",
        ...
        new()
        {
            ...
            Year = 2017,
            Generation = 7,
            OriginGame = "Sun / Moon / Ultra (Gen 7)",
            Region = "Global",
            Tier = EventTier.TierA,
            Category = EventCategory.SpecialFormOrMove,
